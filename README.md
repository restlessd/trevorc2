...
Example of using pyinstaller to turn client script into a Windows executable.
```
cd trevorc2
cp trevorc2_client.py wsupdate.pyw
pyinstaller --onefile --add-data="cert.pem;." --add-data="key.pem;." .\wsupdate.pyw
```
